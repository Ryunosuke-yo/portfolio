        ...
        <>
                <div className="text-white">
                    <div 
                        ...
                        <div className="mt-9 mx-auto text-2xl desktop:text-3xl font-josefin" style={widthStyle}>
                        ...
                        <div className="mt-3 desktop:mt-5 text-lg desktop:text-2xl" style={widthStyle}>
